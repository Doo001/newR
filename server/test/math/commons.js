...
var server = 'http://' + __WEBPACK_IMPORTED_MODULE_9__config___default.a["test"]['proxy']['math']['host'] + ':' + __WEBPACK_IMPORTED_MODULE_9__config___default.a["test"]['proxy']['math']['port'];
