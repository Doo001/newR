...
var UserLogin = function (_React$Component) {
    ...
    function UserLogin() {
        ...
        _this.genImgSrc = function () {
            var server = "http://" + __WEBPACK_IMPORTED_MODULE_10__config___default.a["test"]['proxy']['physics']['host'] + ":" + __WEBPACK_IMPORTED_MODULE_10__config___default.a["test"]['proxy']['physics']['port'];
